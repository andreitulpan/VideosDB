...
public final class QueryFavorite {
    ...
    /**
     * Returneaza primele n video-uri sortate in functie
     * de numarul de adaugari la favorite al show-ului
     *
    ...
    /**
     * Sorteaza lista in functie de numarul de adaugari la favorite, apoi lexicografic
    ...
    private static void sort(final ArrayList<Shows> input,
        ...
        input.sort((s1, s2) -> {
            int comparator = 0;
            // Sortarea se face in functie de numarul de adaugari la favorite
