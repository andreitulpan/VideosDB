...
public final class Rating {
     ...
     * functie de numarul de rating-ul acestora
     *
    ...
    /**
     * Sorteaza lista in functie de rating, apoi lexicografic
    ...
    private static void sort(final ArrayList<Shows> input, final String sortType) {
        input.sort((s1, s2) -> {
            ...
            // Sortarea se face in functie de rating
